 ...
 */
#if (defined(USE_JEMALLOC) || defined(ACC_USE_JEMALLOC)) && !ACC_SANITIZE
...
#define ACC_MALLOC_CHECKED_MALLOC \
  __attribute__((__returns_nonnull__, __malloc__))
#else
#define ACC_MALLOC_CHECKED_MALLOC __attribute__((__malloc__))
#endif
 ...
 */
#if defined(USE_JEMALLOC) && !ACC_SANITIZE
  inline bool usingJEMalloc() noexcept {
    return true;
  }
#else
ACC_NOINLINE inline bool usingJEMalloc() noexcept {
 ...
 */
ACC_MALLOC_CHECKED_MALLOC ACC_NOINLINE inline void* smartRealloc(
    void* p,
