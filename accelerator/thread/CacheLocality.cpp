...
std::atomic<unsigned> FallbackGetcpu::prevId(0);

__thread unsigned FallbackGetcpu::currentId(0);

/////////////// AccessSpreader

Getcpu::Func AccessSpreader::getcpuFunc = AccessSpreader::degenerateGetcpu;

AccessSpreader::CompactStripe
AccessSpreader::widthAndCpuToStripe[kMaxCpus + 1][kMaxCpus] = {};

bool AccessSpreader::initialized = AccessSpreader::initialize();
