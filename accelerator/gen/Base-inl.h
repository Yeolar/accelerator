...
#ifndef ACC_GEN_BASE_H
#error This file may only be included from accelerator/gen/Base.h
#endif
...
/**
 * RangeSource - For producing values from a acc::Range. Useful for referring
 * to a slice of some container.
 *
 * This type is primarily used through the 'from' function, like:
 *
 *   auto rangeSource = from(acc::range(v.begin(), v.end()));
...
class RangeSource : public GenImpl<typename Range<Iterator>::reference,
 ...
 public:
  ...
  // acc::Range only supports finite ranges
  static constexpr bool infinite = false;
};
...
/**
 * UnwrapOr - For unwrapping acc::Optional values, or providing the given
...
/**
 * Unwrap - For unwrapping acc::Optional values in a acc::gen style. Usually
