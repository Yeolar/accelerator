...
#include "accelerator/FormatArg.h"
 ...
 */
class ACC_EXPORT FormatKeyNotFoundException : public std::out_of_range {
 public:
...
/*
 * Specialize acc::FormatValue for your type.
 *
...
#include "accelerator/Format-inl.h"
