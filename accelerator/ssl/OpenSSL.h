...
#define ACC_OPENSSL_IS_100                  \
  (OPENSSL_VERSION_NUMBER >= 0x10000003L && \
   OPENSSL_VERSION_NUMBER < 0x1000105fL)
#define ACC_OPENSSL_IS_101                  \
  (OPENSSL_VERSION_NUMBER >= 0x1000105fL && \
   OPENSSL_VERSION_NUMBER < 0x1000200fL)
#define ACC_OPENSSL_IS_102                  \
  (OPENSSL_VERSION_NUMBER >= 0x1000200fL && \
   OPENSSL_VERSION_NUMBER < 0x10100000L)
#define ACC_OPENSSL_IS_110 (OPENSSL_VERSION_NUMBER >= 0x10100000L)
#endif

#if !OPENSSL_IS_BORINGSSL && !ACC_OPENSSL_IS_100 && !ACC_OPENSSL_IS_101 && \
    !ACC_OPENSSL_IS_102 && !ACC_OPENSSL_IS_110
...
#define ACC_OPENSSL_HAS_SNI 1
#else
#define ACC_OPENSSL_HAS_SNI 0
#endif
...
#define ACC_OPENSSL_HAS_ALPN 1
#else
#define ACC_OPENSSL_HAS_ALPN 0
#endif
...
#if ACC_OPENSSL_IS_100
uint32_t SSL_CIPHER_get_id(const SSL_CIPHER*);
int TLS1_get_client_version(const SSL*);
#endif

#if ACC_OPENSSL_IS_100 || ACC_OPENSSL_IS_101
int X509_get_signature_nid(X509* cert);
#endif

#if ACC_OPENSSL_IS_100 || ACC_OPENSSL_IS_101 || ACC_OPENSSL_IS_102
...
/* using override */ using namespace acc::ssl;
