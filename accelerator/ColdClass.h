...
/* Tag any class as `cold` by inheriting from acc::cold::ColdClass
 *
 * Intended use: things like acc::Unexpected which are designed to only be
...
// without implicitly picking up the acc namespace for ADL on their classes.
namespace cold_detail {
struct ColdClass {
  ACC_COLD ColdClass() noexcept;
};
} // namespace cold
